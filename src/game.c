...
/*   Updated: 2021/09/21 11:43:03 by wollio           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_windows(t_window *win, int width, int height)
{
	...
	win->exity = -1;
	win->mlx = mlx_init();
	win->mlx_win = mlx_new_window(win->mlx, width * 32, height * 32,
			"Hello darling");
	win->floor = mlx_xpm_file_to_image(win->mlx, "./images/floor.xpm",
			&img_width, &img_height);
	win->figure = mlx_xpm_file_to_image(win->mlx, "./images/figure.xpm",
			&img_width, &img_height);
	win->collect = mlx_xpm_file_to_image(win->mlx, "./images/banana.xpm",
			&img_width, &img_height);
	win->wall = mlx_xpm_file_to_image(win->mlx, "./images/wall.xpm",
			&img_width, &img_height);
	win->exit = mlx_xpm_file_to_image(win->mlx, "./images/exit.xpm",
			&img_width, &img_height);
}
